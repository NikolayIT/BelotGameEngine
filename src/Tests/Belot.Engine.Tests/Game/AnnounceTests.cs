namespace Belot.Engine.Tests.Game
{
    ...
    public class AnnounceTests
    {
        ...
        [InlineData(AnnounceType.FourOfAKind, CardSuit.Spade, CardType.Ace, AnnounceType.FourOfAKind, CardSuit.Spade, CardType.Ten, 1)]
        [InlineData(AnnounceType.FourOfAKind, CardSuit.Spade, CardType.Ten, AnnounceType.FourOfAKind, CardSuit.Spade, CardType.King, 1)]
